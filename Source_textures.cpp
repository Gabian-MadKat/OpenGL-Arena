...
void processInput(GLFWwindow* window, float* transparency_value);
...
int main()
{
	...
	Shader myShader("resources/shaders/shaderfile2.vs", "resources/shaders/shaderfile2.fs");
	...
	float* transparency_value = new float;
	* transparency_value = 0.2f;
	...
	{
		// process input
		processInput(window, transparency_value);
		...
		// set mix transparency value
		myShader.setFloat("transparency_val", *transparency_value);
...
void processInput(GLFWwindow* window, float* transparency_value)
{
	...
	{
		*transparency_value -= 0.001f;
		if (*transparency_value <= 0.0f)
			*transparency_value = 0.0f;
	}
}
