...
// specific effects by enabling boolean values specific to those effects.
...
public:
	...
	// Prepares the ppc's framebuffer operations before rendering the game
	void BeginRender();
	// Should be called after rendering the game, so it stores all the rendered data into a texture object
	void EndRender();
	// Renders the PPC texture quad (as a screen-encompassing large sprite)
...
private:
	...
	unsigned int VAO;
	// Initialize quad for rendering PPC texture
	void InitRenderData();
};