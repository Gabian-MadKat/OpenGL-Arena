...
int main()
{
	...
	Shader myShader("resources/shaders/shaderfile_Coordsys.vs", "resources/shaders/shaderfile_Coordsys.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// note: currently we set the projection matrix each frame, but since it rarely changes it's best to set it outside the main loop once
		myShader.setMat4("projection", projection);

		// update object -- render container
		glBindVertexArray(VAO);
		for (int i = 0; i < 10; ++i)
		{
			glm::mat4 model = glm::mat4(1.0f);
